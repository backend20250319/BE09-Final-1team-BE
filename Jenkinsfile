          ...
          changedServicePaths.each { servicePath ->
            ...
            parallelStages["Build & Push ${currentService}"] = {
              try {
                ...
                buildAndPush(serviceName, currentService)
...
// ---------------- helpers ----------------
def buildAndPush(String serviceName, String servicePath) {
  def image = "${ECR_REGISTRY}/${UNIFIED_ECR_REPO}:${serviceName}-latest"
