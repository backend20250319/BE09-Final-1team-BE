        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(
                                ...
                                "/api/news/summary/**",
                                "/api/news/*/summary"       // ID 요약: news/{id}/summary
                        ).permitAll()
                        ...
                        // "collections/**": 모든 컬렉션 관련 API
                        // "news/mypage/**": 마이페이지 뉴스 관련 API (예: 내가 스크랩한 뉴스)
                        .requestMatchers("/api/collections/**", "/api/news/mypage/**").authenticated()

                        // 3-3. 뉴스 목록 조회, 상세 조회 등 GET 요청은 누구나 가능하도록 허용합니다.
                        // "/api/news/**" 경로에 대한 GET 요청만 허용합니다. (예: /api/news/list, news/123)
